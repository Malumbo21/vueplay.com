<template v-for="i in 8">
    <div class="bg-white flex flex-col h-screen">
        <Meta description="Browse through our components library. Drag and drop into your application using Vue Play." title="Components Library" />
        ...
        <main style="width:100%;min-height:calc(100vh - 50px)" class="flex-1 relative overflow-auto">
            <div class="relative h-full w-full flex">
                ...
                <div class="bottom-0 bg-white md:w-96 md:p-7 md:shadow-md shadow-lg pt-24 border-r border-slate-200 peer-checked:px-7 peer-checked:pt-24 peer-checked:pb-7 duration-200 transition-all ease-in-out w-0 max-w-full z-30 peer-checked:w-80 absolute md:relative top-0 overflow-auto">
                    ...
                    <div v-if="false">
                        ...
                        <h3 class="text-slate-500 mt-4 font-medium mb-4 whitespace-nowrap">
                            Description
                        </h3><textarea v-model="description" rows="" cols="" class="resize-none h-24 inline-block pl-2 py-2 w-full border-slate-300 border overflow-hidden border-solid rounded" placeholder="Give helpful details. Add an icon to the component." />
                        <div class="h-16"><button class="w-10 h-10 border-slate-300 border overflow-hidden border-solid rounded mt-6 bg-slate-400 float-left" style="background-size:cover" :style="'background-image: url(' + (icon || background) + ')'" @click="selectImage">

                            </button><button class="ml-1 w-10 h-10 border-slate-300 border overflow-hidden border-solid rounded mt-6 bg-slate-100 p-0 float-left" style="background-size:cover" @click="icon = ''" v-if="icon">
