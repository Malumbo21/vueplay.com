<template v-for="i in 8">
	<div class="bg-slate-100">
		<Meta title="Features"
			description="Vue Play is a full drag & drop designer for building vue components, websites and web applications.">
		</Meta>
		<VueNavigator class="z-10" />
		<header>
			<h1 class="mb-12 text-6xl mt-12">
				Features
			</h1>
			<h1 style="margin-right:auto;margin-left:auto;max-width:calc(100% - 40px);width:700px"
				...
				<div
					...
					<div
						...
						<svg xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
							fill="currentColor"
							class="w-8 h-8 fill-emerald-500 m-auto">
							<path
					...
					<h3
						class="mt-4 mb-3 font-semibold text-2xl text-left">
						Drag and Drop
					</h3>
...
<script>
	...
	export default { setup() {}, components: { VueNavigator,
			Footer, Meta }, data: () => ({}), methods: { open(
