    ...
    <div class="bg-slate-100 flex flex-col h-screen overflow-auto">
        ...
        <main style="width:100%" class="grow">
            ...
            <section>
                ...
                <section style="width:100%;text-align:center"><a class="bg-slate-50 hover:bg-slate-100 rounded-lg" style="margin:auto;width:250px;display:block;border:1px;border-style:solid;border-color:#4599DF;color:#4599DF" href="https://www.facebook.com/groups/vueplay" target="_blank">
                        ...
                        <span style="display:inline-block;font-weight:bold;padding-top:13px;padding-bottom:12px">
                            Follow us on Facebook
                        </span></a><a class="bg-slate-50 hover:bg-slate-100 rounded-lg" style="margin:auto;width:250px;display:block;border:1px;border-style:solid;border-color:#5AB3F0;color:#5AB3F0;margin-top:15px" href="https://t.me/vueplay" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px" style="float:left;padding:5px 0px 5px 5px">
                        ...
                        <span style="padding-top:13px;display:inline-block;font-weight:bold;padding-bottom:12px">
                            Follow us on Telegram
                        </span></a> <a href="https://www.producthunt.com/posts/vue-playground?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-vue&#0045;playground" target="_blank" v-if="false">
                        <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=392346&theme=light" alt="Vue&#0032;Playground - Visual&#0032;drag&#0032;and&#0032;drop&#0032;builder&#0032;for&#0032;vue&#0032;components&#0032;and&#0032;apps | Product Hunt" style="width: 250px; height: 54px;;margin:auto" width="250" height="54" /></a> </section>
            </section>
        </main>
        <Footer class="" />
    </div>
