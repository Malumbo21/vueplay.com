<template>
    <section class="p-6 md:pt-6 pb-24">
        ...
        <article v-for="post in posts.data" class="max-w-2xl mx-auto mb-8 mt-4 flex cursor-pointer">
            ...
            <div class="pl-4 inline-flex cursor-pointer" @click="$router.push('/search/' + post._id)" @mouseenter="post.over = true" @mouseleave="post.over = false"><img class="rounded w-16 h-16" :src="post.icon || background" /> </div>
