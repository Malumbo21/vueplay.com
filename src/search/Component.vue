...
</textarea><iframe src="" title="" class="aspect-square w-full mb-4"></iframe> <button class="mr-2 bg-slate-50 hover:bg-slate-100 shadow rounded px-2 mb-2 py-2" @click="selectImage" v-if="edit">
                        Select icon
