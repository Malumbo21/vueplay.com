            ...
            <div class="lg:grow">
                <div class="lg:float-right mt-4 lg:mt-0 lg:h-full">
                    <div class="relative lg:h-full">
                        ...
                        </div> <input type="search" id="default-search" class="lg:w-44 w-full h-10 lg:h-full max-w-full pl-10 pr-2 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required="" v-model="term" @change="refresh()" />
                    </div>
                </div>
            </div>
        </div>
